    ...
    try:
        ...
        for attempt in range(3):
            ...
            system=(
                ...
                "2. Tüm string değerlerde çift tırnak kullan\n"
                "3. String içinde asla çift tırnak kullanma — tek tırnak veya farklı ifade kullan\n"
                "4. Türkçe karakterler (ş,ğ,ü,ö,ç,ı) kullanabilirsin\n"
                "5. Her string değeri tek satırda yaz — satır sonu \\n kullanma\n"
                "6. HİÇBİR alan boş bırakma — veri yoksa makul tahmin yaz\n\n"
                "ANALİZ ÇERÇEVENİ:\n"
                "1. UPSTREAM PROXY: Brent/Naphtha/Propilen zinciri PP için 4-8 hafta öncül sinyal\n"
                "2. DALIAN FUTURES: Çin PP futures Asya talep sinyali\n"
                "3. ÜRETİCİ: SABIC, Borealis, LyondellBasell kapasite/force majeure haberleri\n"
                "4. LOJİSTİK: Drewry WCI ve Freightos Baltic Index\n"
